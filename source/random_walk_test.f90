...
program random_walk_test
    ...
    integer :: i, j
    integer, parameter :: STEPS = 20, TRIALS = 1

    real :: outputs(1:TRIALS, 1:STEPS, 1:3)
    ...
    block
        current % x = 0.0; current % y = 0.0
        outputs = simulate(trials = trials, steps = steps, randoms=(/0.1, 0.1, 0.8, 0.8/))

        print '(a,i0,a,i0,a)' , "Simulation with ", trials, " trials and ", steps, " steps."
